...
<div class="camera-bg">
    <div class="camera-box">
        ...
        <h3 class="text-center">Or Upload an ID</h3>
        <form action="upload_id.php" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
                <input type="file" name="id_image" class="form-control" required>
            </div>
            <button type="submit" class="btn btn-use">Upload ID</button>
        </form>
    </div>
</div>
<!-- External JS -->
...
<style>
    ...
    .media-content {
        width: 100%;
        height: 100%;
        object-fit: cover; /* This makes sure the image/video fills the circle */
        border-radius: 50%;
    }
